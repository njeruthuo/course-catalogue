"""
Django settings for _home project.
...
SECRET_KEY = 'django-insecure-zq1t9ys%%378@+#8p^*=l_=6+si4x4*4^u_s91%vvp6y5831n0'
...
CLOUDINARY_CLOUD_PUBLIC_KEY = config(
    "CLOUDINARY_CLOUD_PUBLIC_KEY", default="527248555957225")
